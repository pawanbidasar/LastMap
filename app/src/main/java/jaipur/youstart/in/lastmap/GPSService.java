...
/**
 * Created by youstart on 2/11/2016.
 */
...
//        uploader.stopUploading();
    ...
    public void startRecording() {
        ...
        notification = new Notification(R.drawable.overlay5,
                "gps recorder starting....", System.currentTimeMillis());

        // The PendingIntent to launch our activity if the user selects this
        // notification
//        PendingIntent contentIntent = PendingIntent.getActivity(this, 0,new Intent(this, ControlWindow.class), 0);

        // Set the info for the views that show in the notification panel.
//        notification.setLatestEventInfo(this, "gps/uploader status", "running",  contentIntent);
        ...
        for (String provider : locationManager.getAllProviders()) {
            ...
            locationManager.requestLocationUpdates(provider, checkMilliSecs, minDistance,listener);
